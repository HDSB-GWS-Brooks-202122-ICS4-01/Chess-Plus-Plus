...
public class Queen extends Piece {
    ...
    public Queen(Byte id) {
        ...
        if (this.color == 0) {
            ...
            this.sprite.setViewport(new Rectangle2D(Constants.SpriteSheetDimensions.QUEEN_X,
    ...
    public byte[][] getPossibleMoves(byte[][] boardPositions) {
        ...
        possibleMoves = upRightDiagonalMoves(possibleMoves, boardPositions, currentLoc);
        possibleMoves = upLeftDiagonalMoves(possibleMoves, boardPositions, currentLoc);
        possibleMoves = downRightDiagonalMoves(possibleMoves, boardPositions, currentLoc);
        possibleMoves  = downLeftDiagonalMoves(possibleMoves, boardPositions, currentLoc);
     ...
     * @return An array list of byte arrays containing all the added moves. 
     */
    private ArrayList<byte[]> upMoves(ArrayList<byte[]> possibleMoves, byte[][] boardPositions, byte[] currentLoc) {
        if (currentLoc[1] - 1 > -1) {
     ...
     * @return An array list of byte arrays containing all the added moves. 
     */
    private ArrayList<byte[]> downMoves(ArrayList<byte[]> possibleMoves, byte[][] boardPositions, byte[] currentLoc) {
        if (currentLoc[1] + 1 < 8) {
            byte[] possibleMove = { currentLoc[0], (byte) (currentLoc[1] + 1) };
            byte upSquare = boardPositions[possibleMove[0]][possibleMove[1]];
     ...
     * @return An array list of byte arrays containing all the added moves. 
     */
    private ArrayList<byte[]> leftMoves(ArrayList<byte[]> possibleMoves, byte[][] boardPositions, byte[] currentLoc) {
        if (currentLoc[0] - 1 > -1) {
     ...
     * @return An array list of byte arrays containing all the added moves. 
     */
    private ArrayList<byte[]> rightMoves(ArrayList<byte[]> possibleMoves, byte[][] boardPositions, byte[] currentLoc) {
        if (currentLoc[0] + 1 < 8) {
            byte[] possibleMove = { (byte) (currentLoc[0] + 1), currentLoc[1]};
            byte upSquare = boardPositions[possibleMove[0]][possibleMove[1]];
